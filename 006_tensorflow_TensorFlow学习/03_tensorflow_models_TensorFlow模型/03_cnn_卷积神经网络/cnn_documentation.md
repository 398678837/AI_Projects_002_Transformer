...
LeNet-5 是最早的 CNN 架构之一，用于手写数字识别。

### 8.2 AlexNet

AlexNet 是第一个在 ImageNet 比赛中取得突破性成绩的 CNN 架构。

### 8.3 VGGNet

VGGNet 以其简洁的设计和深度而闻名。

### 8.4 GoogLeNet

GoogLeNet 引入了 Inception 模块，提高了模型的效率。
...
MobileNet 专为移动设备设计，使用深度可分离卷积减少参数量。
...
本文档介绍了 CNN 的基本概念、构建方法、训练技巧和常见问题解决方案。通过学习本文档，你应该能够：
