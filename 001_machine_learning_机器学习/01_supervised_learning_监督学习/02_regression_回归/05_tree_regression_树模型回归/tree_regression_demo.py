...
plt.tight_layout()
plt.savefig('images/tree_regression_predictions.png')
print("Predictions可视化已保存为 'tree_regression_predictions.png'")
...
plt.tight_layout()
plt.savefig('images/tree_regression_feature_importance.png')
print("Feature Importance可视化已保存为 'tree_regression_feature_importance.png'")
...
plt.ylabel('R² Score')
plt.title('Effect of Different Tree Depths on Model Performance')
plt.legend()
plt.grid(linestyle='--', alpha=0.7)
plt.savefig('images/tree_regression_depth_effect.png')
...
plt.ylabel('R² Score')
plt.title('Effect of Different Tree Counts on Random Forest Performance')
plt.legend()
plt.grid(linestyle='--', alpha=0.7)
plt.savefig('images/random_forest_n_estimators_effect.png')
