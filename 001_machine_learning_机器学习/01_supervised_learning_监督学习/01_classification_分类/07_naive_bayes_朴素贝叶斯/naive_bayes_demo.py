...
# 7. 查看模型参数
print("\n高斯朴素贝叶斯模型参数:")
print(f" Class先验概率: {gaussian_model.class_prior_}")
print(f" Class计数: {gaussian_model.class_count_}")
...
# 计算不同特征值下的Prediction Probability
probabilities = []
...
plt.savefig('images/naive_bayes_feature_effect.png')
